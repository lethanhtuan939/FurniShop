		...
		<div class="row g-5 mb-5">
			<div class="col-lg-4">
				...
				<ul class="list-unstyled custom-social">
					<li><a href="https://www.facebook.com/profile.php?id=100047458157758"><span class="fa fa-brands fa-facebook-f"></span></a></li>
					<li><a href="#"><span class="fa fa-brands fa-twitter"></span></a></li>
					<li><a href="https://www.instagram.com/_thtuan/"><span class="fa fa-brands fa-instagram"></span></a></li>
					<li><a href="https://www.linkedin.com/in/thanhtuan-l%C3%AA-73676b246/"><span class="fa fa-brands fa-linkedin"></span></a></li>
				</ul>
			</div>
